...
interface LandingElectionCardProps {
  election: Election
...
export function LandingElectionsSection() {
  ...
  return (
    <section className="elections-section section" id="elections-catalog">
